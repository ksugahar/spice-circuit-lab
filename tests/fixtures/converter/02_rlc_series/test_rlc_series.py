...
with schemdraw.Drawing(show=False) as d:
    ...
    print('PDF saved: test_rlc_series.pdf')
...
converter.add_inductor('L1', L_VALUE, (3, 3), (6, 3))
converter.add_capacitor('C1', C_VALUE, (6, 3), (6, 0))
converter.add_wire((6, 0), (0, 0))
converter.add_ground((0, 0))
converter.add_label((6, 3), 'out', is_output=True)
converter.add_spice_directive(0, 512, ".ac dec 100 10 100k")

converter.save_asc('test_rlc_series.asc', sheet_width=1800, sheet_height=680)
print('ASC saved: test_rlc_series.asc')
