#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Auto-generated schemdraw script from test_t_filter.asc"""
...
with schemdraw.Drawing(show=False) as d:
    ...
    d.add(elm.Dot())
    d.push()
    L2 = d.add(elm.Inductor2().at(I1.end).right().label('L2\n1m'))
    d.add(elm.Dot())
    d.push()
    C1 = d.add(elm.Capacitor().at(L2.end).down().label('C1\n100n', loc='left'))
    d.add(elm.Dot())
    d.push()
    ...
    RL = d.add(elm.Resistor().at(C1.end).down().label('RL\n50', loc='left'))
    d.pop()
    L1 = d.add(elm.Inductor2().at(L2.end).right().label('L1\n1m'))
    d.pop()
    d.push()
